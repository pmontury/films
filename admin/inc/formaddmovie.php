...
<div class="wrap" id="content">
  ...
  <form class="" action="" method="post" enctype="multipart/form-data">
    ...
    <label for="title">Titre du film<span>*</span></label>
    ...
    <label for="picture">Ajouter une photo<span>*</span></label>
    ...
    <label for="year">Année du film<span>*</span></label>
    ...
    <label for="genre">Genre du film<span>*</span></label>
    ...
    <label class="labelText" for="plot">Synopsis du film<span>*</span></label>
    ...
    <label for="dik">Réalisateur du film<span>*</span></label>
    ...
    <label for="cast">Acteurs du film<span>*</span></label>
    ...
    <label for="auteur">Auteur du film<span>*</span></label>
    ...
    <label for="runtime">Durée du film<span>*</span></label>
    ...
    <label for="mpaa">Limitation d'age du film<span>*</span></label>
    ...
    <label for="popu">Popularité du film<span>*</span></label>
