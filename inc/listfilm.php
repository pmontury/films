...
<div class="wrap" id="content">
  ...
  <div><a class="button" href="#" onclick="return false;">Voir plus</a></div>

<!-- Ci-dessous la liste des films qui apparaît quand on appuye sur voir plus -->
<?php
$sql = "SELECT * FROM movies_full ORDER BY RAND() LIMIT 100";
$query = $pdo->prepare($sql);
$query->execute();
